...
{   
    ...
    return  a + static_cast <float> (random()) /( static_cast <float> (RAND_MAX/(b-a)));
...
{   
    ...
    for(int i = 0; i<hidden; i++)
    {
        for(int j = 0; j<input; j++)
        {
            ...
            {
                child.matrixNeuron[0][i][j] = matrixNeuron[0][i][j];
            }
            else
            {
    ...
    for(int i = 0; i<output; i++)
    {
        ...
        {   
            ...
            {      
                ...
                child.matrixNeuron[matrixNeuron.size() - 1][i][j] = matrixNeuron[matrixNeuron.size() - 1][i][j];
            }
            else
            {
    ...
    {   
        ...
        for(int i = 0; i<hidden; i++)
        {
            ...
            {   
                if((i < randR) || (i == randR && j <= randC))
                {
                    child.matrixNeuron[k][i][j] = matrixNeuron[k][i][j];
                }
                else
                {
    ...
    */
    for(int i = 0; i<hidden; i++)
    {
        ...
        {   
            ...
            if(rand > 0.5)
                continue;
            matrixNeuron[0][i][j] += randomNumber(-1 , 1) /5;
    ...
    for(int i = 0; i<output; i++)
    {
        ...
        {   
            ...
            if(rand > 0.5)
                continue;
            matrixNeuron[matrixNeuron.size()-1][i][j] += randomNumber(-1, 1) / 5;
    ...
    {   
        for(int i = 0; i<hidden; i++)
        {
            ...
            {   
                ...
                if(rand > 0.5)
                    continue;
                matrixNeuron[k][i][j] += randomNumber(-1, 1) / 5;
